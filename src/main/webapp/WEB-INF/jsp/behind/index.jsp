...
<head>
    ...
    <style>
        ...
        #zheng-upms-server .s-profile>a{background: url(${pageContext.request.contextPath}/images/zheng-upms.png) left top no-repeat;}

        #zheng-cms-admin #header {background: #455EC5;}
        #zheng-cms-admin .content_tab{background: #455EC5;}
        #zheng-cms-admin .s-profile>a{background: url(${pageContext.request.contextPath}/images/zheng-cms.png) left top no-repeat;}

        #zheng-pay-admin #header {background: #F06292;}
        #zheng-pay-admin .content_tab{background: #F06292;}
        #zheng-pay-admin .s-profile>a{background: url(${pageContext.request.contextPath}/images/zheng-pay.png) left top no-repeat;}

        #zheng-ucenter-home #header {background: #6539B4;}
        #zheng-ucenter-home .content_tab{background: #6539B4;}
        #zheng-ucenter-home .s-profile>a{background: url(${pageContext.request.contextPath}/images/zheng-ucenter.png) left top no-repeat;}

        #zheng-oss-web #header {background: #0B8DE5;}
        #zheng-oss-web .content_tab{background: #0B8DE5;}
        #zheng-oss-web .s-profile>a{background: url(${pageContext.request.contextPath}/images/zheng-oss.png) left top no-repeat;}
...
<header id="header">
    <ul id="menu">
        ...
        <li id="logo" class="hidden-xs">
            <a href="${pageContext.request.contextPath}/admin/showLogin">
            ...
            <ul class="hi-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dm-icon pull-right">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a class="waves-effect switch-systems" href="javascript:;" systemid="1" systemname="zheng-upms-server" systemtitle="暗绿色"><i class="zmdi zmdi-shield-security"></i> 暗绿色</a>
                        </li>

                        <li>
                            <a class="waves-effect switch-systems" href="javascript:;" systemid="2" systemname="zheng-cms-admin" systemtitle="深蓝色"><i class="zmdi zmdi-wikipedia"></i> 深蓝色</a>
                        </li>

                        <li>
                            <a class="waves-effect switch-systems" href="javascript:;" systemid="3" systemname="zheng-pay-admin" systemtitle="粉红粉色"><i class="zmdi zmdi-paypal-alt"></i> 粉红粉色</a>
                        </li>

                        <li>
                            <a class="waves-effect switch-systems" href="javascript:;" systemid="4" systemname="zheng-ucenter-home" systemtitle="深紫色"><i class="zmdi zmdi-account"></i> 深紫色</a>
                        </li>

                        <li>
                            <a class="waves-effect switch-systems" href="javascript:;" systemid="5" systemname="zheng-oss-web" systemtitle="浅蓝色"><i class="zmdi zmdi-cloud"></i> 浅蓝色</a>
                        </li>
                    </ul>
                </li>
                <li class="dropdown">
