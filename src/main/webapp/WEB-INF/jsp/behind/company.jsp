...
<script>
    ...
    $(function() {
        ...
        $table.bootstrapTable({
            url: '${pageContext.request.contextPath}/comp/companyList',
            height: getHeight(),
            striped: true,
            search: true,
            ...
            columns: [
                ...
                {field: 'intro', title: '公司简介', sortable: true, halign: 'center'},
                {field: 'culture', title: '公司文化', sortable: true, halign: 'center'},
                {field: 'merit', title: '公司技术', sortable: true, halign: 'center'},
